      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a target={"_blank"} href={data.lesson.challenge.url} className="p-4 text-sm border border-red-500 text-red-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-red-500 hover:text-gray-900 transition-colors">
              <Lightning size={24}/>
            Acesse o desafio
            </a>
          </div>
